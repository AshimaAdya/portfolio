        ...
        <div className="max-w-4xl mx-auto text-center md:text-left">
          ...
          >
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-muted/50 border border-border/50 text-sm font-medium text-muted-foreground mb-8">
              ...
              Vancouver, Canada - Open to Remote
            </div>
          ...
          >
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mb-10 leading-relaxed md:mx-0 mx-auto">
              I build the backend systems and data platforms that make products work at scale. Confident architecture, reliable execution, and quiet performance.
            </p>
          </motion.div>
          ...
          >
            ...
            <a 
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-white text-foreground px-8 py-3.5 rounded-full font-medium border border-border hover:border-primary hover:text-primary transition-all shadow-sm"
            >
          ...
          >
            <a href="mailto:ashima.adya@gmail.com" className="text-muted-foreground hover:text-primary transition-colors border-b border-transparent hover:border-primary pb-0.5">
